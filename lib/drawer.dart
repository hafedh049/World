            ...
            children: <Widget>[
              ...
              StatefulBuilder(
                builder: (BuildContext context, void Function(void Function()) _) {
                  return InkWell(
                    onTap: () => true,
                    onHover: (bool value) => _(() => _me = value),
                    splashColor: transparent,
                    hoverColor: transparent,
                    highlightColor: transparent,
                    child: Column(
                      ...
                      children: <Widget>[
                        Row(
                          mainAxisSize: MainAxisSize.min,
                          children: <Widget>[
                            const CircleAvatar(radius: 15, backgroundColor: blue, child: CircleAvatar(backgroundImage: AssetImage("assets/me.png"))),
                            const SizedBox(width: 10),
                            Text("Powered by me.", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: _me ? blue : null)),
                          ],
                        ),
                        const SizedBox(height: 5),
                        AnimatedContainer(duration: 700.ms, height: .9, width: _me ? 15 + 5 : 0, color: white),
                      ],
                    ),
                  );
                },
