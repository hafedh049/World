      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            decoration: BoxDecoration(borderRadius: BorderRadius.circular(5), color: currentGame!.state_ == "LOSS" ? red.withOpacity(.6) : green.withOpacity(.6)),
            child: Center(child: Text(currentGame!.magicWord_["word"], style: const TextStyle(color: white, fontWeight: FontWeight.bold, fontSize: 16))),
          ),
          const SizedBox(height: 10),
          Container(
            padding: const EdgeInsets.all(4),
            decoration: BoxDecoration(borderRadius: BorderRadius.circular(5), color: blue.withOpacity(.6)),
            child: Center(child: Text(currentGame!.magicWord_["description"], style: const TextStyle(color: white, fontWeight: FontWeight.bold, fontSize: 16))),
          ),
        ],
      ),
    ),
